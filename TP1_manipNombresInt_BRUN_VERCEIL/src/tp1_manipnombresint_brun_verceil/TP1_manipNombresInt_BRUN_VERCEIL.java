...
public class TP1_manipNombresInt_BRUN_VERCEIL {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Nombre 1 : "+ nb3); // On affiche notre premier nombre.
        System.out.println("Nombre 2 : "+ nb2); // On affiche notre second nombre.
        
        System.out.println("La somme de vos deux nombre est "+(nb3+nb2)); // Affichage de la somme de nos 2 nombres
        System.out.println("La différence de vos deux nombre est "+(nb3-nb2)); // Affichage de la différences des 2 nombres
        System.out.println("Le produit de vos deux nombre est "+(nb3*nb2)); // Affichage du produit de nos 2 nombres

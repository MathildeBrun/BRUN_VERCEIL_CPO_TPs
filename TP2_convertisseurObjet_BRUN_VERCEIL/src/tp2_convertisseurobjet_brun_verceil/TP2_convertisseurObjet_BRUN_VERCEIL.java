...
public class TP2_ConvertisseurObjet_BRUN_VERCEIL {
    ...
    public static void main(String[] args) {
        ...
        Convertisseur troisiemeConversions = new Convertisseur();
